 ...
 */
package ao.hybris.training.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(AotrainingFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AotrainingFulfilmentProcessConstants.PARENT_PROCESS);
