 ...
 */
package ao.hybris.training.fulfilmentprocess.test.jobs;
...
import ao.hybris.training.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = AotrainingFulfilmentProcessConstants.ORDER_PROCESS_NAME;
