 ...
 */
package ao.hybris.training.core.constants;

/**
 * Global class for all AotrainingCore constants. You can add global constants for your extension into this class.
 */
public final class AotrainingCoreConstants extends GeneratedAotrainingCoreConstants
{
	public static final String EXTENSIONNAME = "aotrainingcore";


	private AotrainingCoreConstants()
	{
		//empty
	}
