 ...
 */
package ao.hybris.training.test.setup;
...
import ao.hybris.training.test.constants.AotrainingTestConstants;
import ao.hybris.training.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AotrainingTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/aotrainingtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/aotrainingtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/aotrainingtest/import/cstickets.impex");
			...
			importImpexFile(context, "/aotrainingtest/import/csquotes.impex");
		}
	}
}
